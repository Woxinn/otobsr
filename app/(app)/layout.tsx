    ...
    <div className="min-h-screen text-[var(--ink)]">
      <div className="mx-auto max-w-7xl px-6 pb-24 pt-10">
        ...
        <nav className="mb-10 flex flex-wrap gap-2 text-sm font-medium">
          {[
            { key: "dashboard", href: "/", label: "Gösterge Paneli" },
            { key: "shipments", href: "/shipments", label: "Sevkiyatlar" },
            ...
            { key: "order-plan", href: "/konteyner-planlama", label: "Konteyner Planlama" },
            { key: "rfqs", href: "/rfqs", label: "Teklif Talepleri" },
            { key: "proformas", href: "/proformalar", label: "Proformalar" },
            { key: "product-groups", href: "/product-groups", label: "Ürün Kategorileri" },
            { key: "gtips", href: "/gtips", label: "GTİP'ler" },
            ...
            { key: "forwarders", href: "/forwarders", label: "Lojistik Firmaları" },
