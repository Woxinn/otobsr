...
import ProductGroupNotesWidget from "@/components/ProductGroupNotesWidget";
  ...
  return (
    <section className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_360px] xl:grid-cols-[1fr_400px]">
        {/* Left Column: Category Form & Attributes */}
        ...
        {/* Right Column: Category Notes */}
        <div className="space-y-6">
          <ProductGroupNotesWidget
            groupId={group.id}
            notes={groupNotes ?? []}
